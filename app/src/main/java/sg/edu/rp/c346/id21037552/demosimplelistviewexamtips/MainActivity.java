package sg.edu.rp.c346.id21037552.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tips = new String[5];      //UI

        tips[0] = "Don't just read the code, code it as much as possible during each practical session";        //Data
        ...
        aa = new ArrayAdapter<>(MainActivity.this, //Where to display
                android.R.layout.simple_list_item_1,    //How to display
                tips);                                 //What to display
